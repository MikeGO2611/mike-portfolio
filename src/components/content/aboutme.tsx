...
export default function AboutMe() {
    ...
    <div className="content">
        ...
        <p>I am Miguel "Mike" González Obenza, or Mike Obenza for short. I'm a developer located in Spain interested in may different topics. I've studied a degree on <em>Audiovisual Communication</em> and later a master's degree on <em>Design, Development, and Marketing of Video Games</em>.</p>
